...
public class Constants {
    ...
    //판매 기간
    public static int SELL_IN_STANDARD = 0;
    ...
    public static int BACKSTAGE_PASSES_INCREASE_2_TIMES = 2;

    //Sulfuras
    public static int SULFURAS_QUALITY = 80;

    //Aged Brie
    public static int AGED_BRIE_INCREASE_AMOUNT = 1;

    //Conjured
    public static int CONJURED_DECREASE_RATE = 2;
}
